...
if __name__ == "__main__":
    ...
    subprocess.call(["./write_fixed_len_pages", "large.csv", "foo_bar_output_file", "65536", "--no-output"])
    os.remove("foo_bar_output_file")

    for page_size in PAGE_SIZES:
        print("======================== {} ========================".format(page_size))
        for _ in range(0, 5):
            subprocess.call(["./write_fixed_len_pages", "large.csv", "page_file", page_size])
            os.remove("page_file")
